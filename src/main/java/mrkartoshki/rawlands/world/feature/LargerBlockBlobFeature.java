...
public class LargerBlockBlobFeature extends Feature<BlockStateConfiguration> {

    public LargerBlockBlobFeature(Codec<BlockStateConfiguration> codec) {
        super(codec);
    }

    @Override
    public boolean place(FeaturePlaceContext<BlockStateConfiguration> featurePlaceContext) {
        int blob_size = 2 + nextInt(0,2);
